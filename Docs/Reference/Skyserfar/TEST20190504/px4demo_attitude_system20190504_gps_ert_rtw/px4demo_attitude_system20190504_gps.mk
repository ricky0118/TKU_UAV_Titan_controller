###########################################################################
## Makefile generated for Simulink model 'px4demo_attitude_system20190504_gps'. 
## 
## Makefile     : px4demo_attitude_system20190504_gps.mk
## Generated on : Fri Mar 13 17:42:25 2020
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/px4demo_attitude_system20190504_gps.pre.o
...
PRODUCT_NAME              = px4demo_attitude_system20190504_gps
MAKEFILE                  = px4demo_attitude_system20190504_gps.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = px4demo_attitude_system20190504_gps_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/px4demo_attitude_system20190504_gps.pre.o
...
DEFINES_STANDARD = -DMODEL=px4demo_attitude_system20190504_gps -DNUMST=5 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(MATLAB_ROOT)/toolbox/psp/pixhawk/src/PX4_sysobj_serial.c $(START_DIR)/px4demo_attitude_system20190504_gps_ert_rtw/px4demo_attitude_system20190504_gps.c $(MATLAB_ROOT)/toolbox/psp/pixhawk/src/nuttxinitialize.c

MAIN_SRC = $(START_DIR)/px4demo_attitude_system20190504_gps_ert_rtw/ert_main.c
...
OBJS = PX4_sysobj_serial.o px4demo_attitude_system20190504_gps.o nuttxinitialize.o
...
MODELREF_LIBS = ./px4demo_attitude_control20190311gps_rtwlib.lib
...
%.o : $(START_DIR)/px4demo_attitude_system20190504_gps_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"
