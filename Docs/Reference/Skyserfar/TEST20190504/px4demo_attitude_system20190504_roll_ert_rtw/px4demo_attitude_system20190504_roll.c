 ...
 *
 * File: px4demo_attitude_system20190504_roll.c
 *
...
const uint8_T px4demo_attitude_system20190504_roll_U8GND = 0U;/* uint8_T ground */
...
/* Model step function */
void px4demo_attitude_system20190504_roll_step(void)
{
    ...
    if ((px4demo_attitude_system201905_B.DataTypeConversion > 0) &&
      ...
      if (px4demo_attitude_system201905_B.DataTypeConversion == 1) {
        ...
        write(px4demo_attitude_system20190_DW.Speaker_Tune_tune_fd, (uint8_T*)
              &px4demo_attitude_system20190504_roll_U8GND, 1);
      }
    }
  ...
  px4demo_attitude_system201905_B.TmpSignalConversionAtSFunct[2] =
    px4demo_attitude_system201905_B.Gain1;
  px4demo_attitude_system201905_B.TmpSignalConversionAtSFunct[3] = 0.0F;
  px4demo_attitude_system201905_B.TmpSignalConversionAtSFunct[4] = 0.0F;
...
void px4demo_attitude_system20190504_roll_initialize(void)
{
  /* Registration code */
...
void px4demo_attitude_system20190504_roll_terminate(void)
{
  uint8_T devName[11];
