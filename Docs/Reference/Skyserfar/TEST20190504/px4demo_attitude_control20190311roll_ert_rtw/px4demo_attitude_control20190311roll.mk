###########################################################################
## Makefile generated for Simulink model 'px4demo_attitude_control20190311roll'. 
## 
## Makefile     : px4demo_attitude_control20190311roll.mk
## Generated on : Sat May 11 23:52:31 2019
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/px4demo_attitude_control20190311roll.pre.o
...
PRODUCT_NAME              = px4demo_attitude_control20190311roll
MAKEFILE                  = px4demo_attitude_control20190311roll.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/DELL/Desktop/TEST20190504
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = GCC ARM Cortex-A9
MODELREF_LINK_RSPFILE_NAME = px4demo_attitude_control20190311roll_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/px4demo_attitude_control20190311roll.pre.o
...
DEFINES_ = -DMODEL=px4demo_attitude_control20190311roll -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DUSE_STDPERIPH_DRIVER -DPX4 -DCONFIG_ARCH_BOARD_PX4FMU_V2 -DGIT_VERSION=d3398270e101359de9687c2d077d991c9892f573 -D__DF_NUTTX -D__PX4_NUTTX -DARM_MATH_CM4=1 -D__FPU_PRESENT=1 -D__FPU_USED=1 -DHSE_VALUE=8000000 -DNULL=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLEPRINTF -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=px4demo_attitude_control20190311roll -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/px4demo_attitude_control20190311roll_ert_rtw/px4demo_attitude_control20190311roll.c $(START_DIR)/px4demo_attitude_control20190311roll_ert_rtw/px4demo_attitude_control20190311roll_data.c $(MATLAB_ROOT)/toolbox/psp/pixhawk/src/nuttxinitialize.c

MAIN_SRC = $(START_DIR)/px4demo_attitude_control20190311roll_ert_rtw/ert_main.c
...
OBJS = px4demo_attitude_control20190311roll.o px4demo_attitude_control20190311roll_data.o nuttxinitialize.o
...
%.o : $(START_DIR)/px4demo_attitude_control20190311roll_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
nuttxinitialize.o : $(MATLAB_ROOT)/toolbox/psp/pixhawk/src/nuttxinitialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"
