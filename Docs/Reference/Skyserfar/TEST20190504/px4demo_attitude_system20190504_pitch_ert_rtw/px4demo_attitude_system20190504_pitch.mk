###########################################################################
## Makefile generated for Simulink model 'px4demo_attitude_system20190504_pitch'. 
## 
## Makefile     : px4demo_attitude_system20190504_pitch.mk
## Generated on : Fri Mar 13 18:39:26 2020
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/px4demo_attitude_system20190504_pitch.pre.o
...
PRODUCT_NAME              = px4demo_attitude_system20190504_pitch
MAKEFILE                  = px4demo_attitude_system20190504_pitch.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = px4demo_attitude_system20190504_pitch_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/px4demo_attitude_system20190504_pitch.pre.o
...
DEFINES_STANDARD = -DMODEL=px4demo_attitude_system20190504_pitch -DNUMST=5 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(MATLAB_ROOT)/toolbox/psp/pixhawk/src/PX4_sysobj_serial.c $(START_DIR)/px4demo_attitude_system20190504_pitch_ert_rtw/px4demo_attitude_system20190504_pitch.c $(START_DIR)/px4demo_attitude_system20190504_pitch_ert_rtw/px4demo_attitude_system20190504_pitch_data.c $(MATLAB_ROOT)/toolbox/psp/pixhawk/src/nuttxinitialize.c

MAIN_SRC = $(START_DIR)/px4demo_attitude_system20190504_pitch_ert_rtw/ert_main.c
...
OBJS = PX4_sysobj_serial.o px4demo_attitude_system20190504_pitch.o px4demo_attitude_system20190504_pitch_data.o nuttxinitialize.o
...
MODELREF_LIBS = ./px4demo_attitude_control20190311pitch_rtwlib.lib
...
%.o : $(START_DIR)/px4demo_attitude_system20190504_pitch_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"
