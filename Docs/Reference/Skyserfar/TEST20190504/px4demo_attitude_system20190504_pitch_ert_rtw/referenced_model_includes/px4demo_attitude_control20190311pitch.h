 ...
 *
 * File: px4demo_attitude_control20190311pitch.h
 *
...
#ifndef RTW_HEADER_px4demo_attitude_control20190311pitch_h_
#define RTW_HEADER_px4demo_attitude_control20190311pitch_h_
#include <string.h>
#ifndef px4demo_attitude_control20190311pitch_COMMON_INCLUDES_
# define px4demo_attitude_control20190311pitch_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "rtw_continuous.h"
#include "rtw_solver.h"
#endif                                 /* px4demo_attitude_control20190311pitch_COMMON_INCLUDES_ */

#include "px4demo_attitude_control20190311pitch_types.h"
...
/* Block signals for model 'px4demo_attitude_control20190311pitch' */
typedef struct {
  real_T Sum;                          /* '<S16>/Sum' */
  real_T Saturate;                     /* '<S16>/Saturate' */
  real_T Sum2;                         /* '<S3>/Sum2' */
  real_T Sum_n;                        /* '<S17>/Sum' */
  real_T Saturate_b;                   /* '<S17>/Saturate' */
  real_T Sum_e;                        /* '<S3>/Sum' */
  real_T Sum_a;                        /* '<S15>/Sum' */
  real_T Saturate_p;                   /* '<S15>/Saturate' */
  real_T Sum3;                         /* '<S3>/Sum3' */
  real_T Sum_c;                        /* '<S14>/Sum' */
  real_T Saturate_c;                   /* '<S14>/Saturate' */
...
/* Block states (auto storage) for model 'px4demo_attitude_control20190311pitch' */
typedef struct {
  real_T Integrator_DSTATE;            /* '<S16>/Integrator' */
  real_T Integrator_DSTATE_c;          /* '<S17>/Integrator' */
  real_T Integrator_DSTATE_n;          /* '<S15>/Integrator' */
  real_T Integrator_DSTATE_p;          /* '<S14>/Integrator' */
...
/* Invariant block signals for model 'px4demo_attitude_control20190311pitch' */
typedef struct {
...
extern void px4demo_attitude_control2019031(const real32_T *rtu_roll, const
  ...
  uint16_T *rtu_ch6, const int32_T *rtu_P, const int32_T *rtu_Q, uint16_T
 ...
 *
 * '<Root>' : 'px4demo_attitude_control20190311pitch'
 * '<S1>'   : 'px4demo_attitude_control20190311pitch/ARMINGControl'
 * '<S2>'   : 'px4demo_attitude_control20190311pitch/ARMINGControl1'
 * '<S3>'   : 'px4demo_attitude_control20190311pitch/AttitudeControl'
 * '<S4>'   : 'px4demo_attitude_control20190311pitch/InputConditioning'
 * '<S5>'   : 'px4demo_attitude_control20190311pitch/pwm_out1'
 * '<S6>'   : 'px4demo_attitude_control20190311pitch/pwm_out2'
 * '<S7>'   : 'px4demo_attitude_control20190311pitch/ARMINGControl/Compare To Constant3'
 * '<S8>'   : 'px4demo_attitude_control20190311pitch/ARMINGControl1/Compare To Constant3'
 * '<S9>'   : 'px4demo_attitude_control20190311pitch/AttitudeControl/MATLAB Function1'
 * '<S10>'  : 'px4demo_attitude_control20190311pitch/AttitudeControl/MATLAB Function2'
 * '<S11>'  : 'px4demo_attitude_control20190311pitch/AttitudeControl/MATLAB Function3'
 * '<S12>'  : 'px4demo_attitude_control20190311pitch/AttitudeControl/MATLAB Function4'
 * '<S13>'  : 'px4demo_attitude_control20190311pitch/AttitudeControl/MATLAB Function6'
 * '<S14>'  : 'px4demo_attitude_control20190311pitch/AttitudeControl/PITCH'
 * '<S15>'  : 'px4demo_attitude_control20190311pitch/AttitudeControl/pitch'
 * '<S16>'  : 'px4demo_attitude_control20190311pitch/AttitudeControl/roll'
 * '<S17>'  : 'px4demo_attitude_control20190311pitch/AttitudeControl/roll1'
 */
#endif                                 /* RTW_HEADER_px4demo_attitude_control20190311pitch_h_ */
