...
## Generated on : Sat May 11 23:50:53 2019
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: ./px4demo_attitude_control20190311roll_rtwlib.lib
...
MODELLIB                  = px4demo_attitude_control20190311roll_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
SHARED_OBJS               =  \
...
PRODUCT = ./px4demo_attitude_control20190311roll_rtwlib.lib
...
SRCS = $(START_DIR)/slprj/ert/px4demo_attitude_control20190311roll/px4demo_attitude_control20190311roll.c $(START_DIR)/slprj/ert/px4demo_attitude_control20190311roll/px4demo_attitude_control20190311roll_data.c
...
OBJS = px4demo_attitude_control20190311roll.o px4demo_attitude_control20190311roll_data.o
...
%.o : $(START_DIR)/slprj/ert/px4demo_attitude_control20190311roll/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"
