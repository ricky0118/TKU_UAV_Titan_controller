...
/* System initialize for referenced model: 'px4demo_attitude_control20190311gps' */
...
/* Output and update for referenced model: 'px4demo_attitude_control20190311gps' */
void px4demo_attitude_control2019031(const real32_T *rtu_roll, const real32_T
  ...
  *rtu_ch6, const real32_T *rtu_P, const real32_T *rtu_Q, const real32_T
  *rtu_yaw, const int32_T *rtu_lat, const int32_T *rtu_long, const real32_T
  *rtu_attin1, uint16_T rty_PWM[4], boolean_T *rty_ARM_Control, real_T *rty_q1,
  real_T *rty_q, real32_T *rty_y_out, real32_T *rty_lat_out, real32_T
  *rty_long_out, real32_T *rty_waypoint, real32_T *rty_distance, real32_T
  *rty_rollout, real32_T *rty_pitchout, boolean_T *rty_mode,
  ...
  *localDW)
{
  ...
  real32_T rtb_DataTypeConversion1_j;
  real32_T rtb_Saturation7;
  static const int32_T position[4] = { 251759030, 251755740, 1214507050,
    1214500690 };
  ...
  if (rtmIsSampleHit(1, 0)) {
     ...
     */
    localB->u0 = ((real32_T)*rtu_ch4 - 1500.0F) / 400.0F;

    /* Saturate: '<S4>/Saturation7' */
    if (localB->u0 > 1.0F) {
      rtb_Saturation7 = 1.0F;
    } else if (localB->u0 < (-1.0F)) {
      rtb_Saturation7 = (-1.0F);
    } else {
      rtb_Saturation7 = localB->u0;
    }
  ...
  if (localB->Gain3 <= 0.0F) {
    /* '<S17>:1:2' */
    /* '<S17>:1:3' */
    localB->y_fv = 360.0F + localB->Gain3;
  } else {
    /* '<S17>:1:5' */
    localB->y_fv = localB->Gain3;
  }
  ...
  *rty_long_out = (real32_T)*rtu_long;
  ...
  if (rtmIsSampleHit(1, 0)) {
    ...
    localB->y_f = localDW->UnitDelay2_DSTATE;
    ...
    if ((localDW->UnitDelay3_DSTATE == 1.0) && (localDW->UnitDelay2_DSTATE <=
      ...
      /* '<S15>:1:2' */
      /* '<S15>:1:3' */
      localB->y_f = localDW->UnitDelay2_DSTATE + 1.0;
    }
    ...
    *rty_waypoint = (real32_T)localB->y_f;
  }
  ...
  /* '<S9>:1:9' */
  localB->u0 = (real32_T)position[(int32_T)*rty_waypoint - 1] - *rty_lat_out;
  ...
  /* '<S9>:1:12' */
  localB->rtb_Switch1_idx_3 = (real32_T)position[(int32_T)*rty_waypoint - 1] -
    *rty_lat_out;
  localB->rtb_Switch1_idx_2 = (real32_T)position[(int32_T)*rty_waypoint + 1] -
    *rty_long_out;
  ...
  localB->vector_a1_idx_0 = (real32_T)position[(int32_T)*rty_waypoint - 1] -
    *rty_lat_out;
  localB->vector_a1_idx_1 = (real32_T)position[(int32_T)*rty_waypoint + 1] -
    *rty_long_out;

  /* '<S9>:1:18' */
  localB->vector_b1_idx_0 = localB->RateTransition - *rty_lat_out;
  localB->vector_b1_idx_1 = localB->RateTransition1 - *rty_long_out;

  /* '<S9>:1:20' */
  localB->rtb_Switch1_idx_3 = (real32_T)sqrt(localB->rtb_Switch1_idx_3 *
    localB->rtb_Switch1_idx_3 + localB->rtb_Switch1_idx_2 *
    localB->rtb_Switch1_idx_2) / 1000.0F;

  /* vector_a_y=(position(x,1)-latitutde); */
  /* vector_a_x=(position(x,2)-longitude); */
  /* '<S9>:1:24' */
  localB->rtb_Switch1_idx_2 = (real32_T)atan(localB->rtb_Switch1_idx_1 /
    localB->u0) * 57.2957802F;
  if (((real_T)position[(int32_T)*rty_waypoint - 1] >= *rty_lat_out) && ((real_T)
       position[(int32_T)*rty_waypoint + 1] >= *rty_long_out)) {
    /* '<S9>:1:26' */
    /* '<S9>:1:27' */
    localB->rtb_Switch1_idx_2 = (real32_T)fabs(localB->rtb_Switch1_idx_2);
    ...
    /* '<S9>:1:29' */
    /* '<S9>:1:30' */
    localB->rtb_Switch1_idx_2 = (localB->rtb_Switch1_idx_2 + 90.0F) + 90.0F;
    ...
    /* '<S9>:1:32' */
    /* '<S9>:1:33' */
    localB->rtb_Switch1_idx_2 += 180.0F;

    /* '<S9>:1:34' */
    localB->q = 3;
  } else {
    /* '<S9>:1:36' */
    localB->rtb_Switch1_idx_2 = (localB->rtb_Switch1_idx_2 + 90.0F) + 270.0F;

    /* '<S9>:1:37' */
    localB->q = 4;
  }

  if ((localB->y_fv <= 90.0F) && (localB->y_fv > 0.0F)) {
    /* '<S9>:1:39' */
    /* '<S9>:1:40' */
    localB->q1 = 1;
  } else if ((localB->y_fv <= 180.0F) && (localB->y_fv > 90.0F)) {
    /* '<S9>:1:41' */
    /* '<S9>:1:42' */
    localB->q1 = 2;
  } else if ((localB->y_fv <= 270.0F) && (localB->y_fv > 180.0F)) {
    /* '<S9>:1:43' */
    /* '<S9>:1:44' */
    localB->q1 = 3;
  } else {
  ...
  /* '<S9>:1:48' */
  localB->dif_thera = localB->rtb_Switch1_idx_2 - localB->y_fv;
  if ((localB->q == 4) && (localB->q1 == 1)) {
    ...
    /* '<S9>:1:90' */
    localB->y_n = 0.0;
  } else if (localB->rtb_Switch1_idx_2 == 90.0F) {
    /* '<S9>:1:92' */
    /* '<S9>:1:93' */
    localB->y_n = 0.0;
    ...
    /* '<S9>:1:94' */
    localB->y1 = 1;
  } else if (localB->rtb_Switch1_idx_2 == 180.0F) {
    /* '<S9>:1:95' */
    /* '<S9>:1:96' */
    localB->y_n = 0.0;
    ...
    /* '<S9>:1:97' */
    localB->y1 = 1;
  } else if (localB->rtb_Switch1_idx_2 == 270.0F) {
    /* '<S9>:1:98' */
    /* '<S9>:1:99' */
    localB->y_n = 0.0;
  ...
  /* end */
  /* '<S9>:1:166' */
  localB->pn[0] = localB->vector_a1_idx_1 * 0.0F - 0.0F *
    localB->vector_b1_idx_1;
  localB->pn[1] = 0.0F * localB->vector_b1_idx_0 - localB->vector_a1_idx_0 *
    0.0F;
  localB->pn[2] = localB->vector_a1_idx_0 * localB->vector_b1_idx_1 -
    localB->vector_a1_idx_1 * localB->vector_b1_idx_0;
  ...
  if (localB->rtb_Switch1_idx_3 < 2.0F) {
    /* '<S9>:1:190' */
    /* '<S9>:1:191' */
    localB->arrival = 1;
  } else {
  ...
  /*  reset=round(0) */
  /* end */
  rtb_thera_new2 = localB->rtb_Switch1_idx_2;
  *rty_q = localB->q;
  *rty_q1 = localB->q1;
  *rty_distance = localB->rtb_Switch1_idx_3;
  rtb_vector_a_y = localB->u0;
  ...
  *rty_mode = localDW->Delay1_DSTATE;
  ...
  if (*rty_mode) {
    ...
    localB->rtb_Switch1_idx_2 = 0.0F;
    localB->rtb_Switch1_idx_3 = 0.0F;
  } else {
    /* DataTypeConversion: '<Root>/Data Type Conversion' */
    rtb_DataTypeConversion = *rtu_P;

    /* DataTypeConversion: '<Root>/Data Type Conversion1' */
    rtb_DataTypeConversion1_j = *rtu_Q;

    /* DataTypeConversion: '<S3>/Data Type Conversion4' */
    rtb_DataTypeConversion4_m = *rtu_roll;
    localB->rtb_Switch1_idx_1 = *rtu_pitch;
    localB->rtb_Switch1_idx_2 = rtb_DataTypeConversion;
    localB->rtb_Switch1_idx_3 = rtb_DataTypeConversion1_j;
  }
   ...
   */
  localB->u0 = ((real32_T)*rtu_ch1 - 1500.0F) / 400.0F;
  ...
  localB->Sum = ((1.0F * localB->sf_MATLABFunction3.y -
                  localB->sf_MATLABFunction4.y) + 1.0F * *rty_y_out) *
    1.10009301262288 + localDW->Integrator_DSTATE;
   ...
   */
  localB->Sum2 = localB->Saturate - localB->rtb_Switch1_idx_2;

  /* Sum: '<S23>/Sum' incorporates:
   *  DiscreteIntegrator: '<S23>/Integrator'
   *  Gain: '<S23>/Proportional Gain'
   */
  localB->Sum_j = 0.0549143230570902 * localB->Sum2 +
    localDW->Integrator_DSTATE_g;

  /* Saturate: '<S23>/Saturate' */
  if (localB->Sum_j > 1.0) {
    localB->Saturate_o = 1.0;
  } else if (localB->Sum_j < (-1.0)) {
    localB->Saturate_o = (-1.0);
  } else {
    localB->Saturate_o = localB->Sum_j;
  }

  /* End of Saturate: '<S23>/Saturate' */

  /* DataTypeConversion: '<S3>/Data Type Conversion6' */
  *rty_rollout = (real32_T)localB->Saturate_o;

  /* Fcn: '<S4>/Fcn5' incorporates:
   *  DataTypeConversion: '<S4>/Data Type Conversion3'
   */
  localB->u0 = ((real32_T)*rtu_ch2 - 1500.0F) / 400.0F;
  ...
  *rty_ARM_Control = localDW->Delay_DSTATE;
  ...
  /* '<S19>:1:3' */
  localB->y_i = rt_roundf_snf(*rtu_attin1 - localB->Switch2);
  ...
  /* '<S18>:1:2' */
  /* '<S18>:1:3' */
  if (localB->y_i <= 70.0 - 2.0) {
    /* '<S18>:1:4' */
    /* '<S18>:1:5' */
    localB->y = 1;
  } else if (localB->y_i >= 70.0 + 2.0) {
    /* '<S18>:1:6' */
    /* '<S18>:1:7' */
    localB->y = -1;
  } else {
  ...
  localB->Sum_e = ((real_T)(1.0F * localB->sf_MATLABFunction2.y) -
                   localB->sf_MATLABFunction1.y) + 0.0 * (real_T)localB->y;
   ...
   */
  localB->Sum_m = 1.8545410952272 * localB->Sum_e + localDW->Integrator_DSTATE_n;

  /* Saturate: '<S21>/Saturate' */
  if (localB->Sum_m > 1.0) {
    localB->Saturate_d = 1.0;
  } else if (localB->Sum_m < (-1.0)) {
    localB->Saturate_d = (-1.0);
  } else {
    localB->Saturate_d = localB->Sum_m;
  }
   ...
   */
  localB->Sum3 = localB->Saturate_d - localB->rtb_Switch1_idx_3;

  /* Sum: '<S20>/Sum' incorporates:
   *  DiscreteIntegrator: '<S20>/Integrator'
   *  Gain: '<S20>/Proportional Gain'
   */
  localB->Sum_f = 0.92594405565099358 * localB->Sum3 +
    localDW->Integrator_DSTATE_k;

  /* Saturate: '<S20>/Saturate' */
  if (localB->Sum_f > 1.0) {
    localB->Saturate_h = 1.0;
  } else if (localB->Sum_f < (-1.0)) {
    localB->Saturate_h = (-1.0);
  } else {
    localB->Saturate_h = localB->Sum_f;
  }

  /* End of Saturate: '<S20>/Saturate' */

  /* DataTypeConversion: '<S3>/Data Type Conversion7' */
  *rty_pitchout = (real32_T)localB->Saturate_h;

  /* Gain: '<Root>/Gain1' */
  rtb_Gain1 = (-1.0F) * *rty_rollout;
   ...
   */
  localB->u0 = ((real32_T)*rtu_ch3 - 1100.0F) / 800.0F;

  /* Saturate: '<S4>/Saturation10' */
  if (localB->u0 > 1.0F) {
    rtb_Saturation10 = 1.0F;
  } else if (localB->u0 < 0.0F) {
    rtb_Saturation10 = 0.0F;
  } else {
    rtb_Saturation10 = localB->u0;
  }

  /* End of Saturate: '<S4>/Saturation10' */

  /* MATLAB Function: '<Root>/pwm_out1' */
  px4demo_attitude_contr_pwm_out1(rtb_Gain1, rtb_Gain2_a, localB->Gain5,
  ...
  if (rtmIsSampleHit(1, 0)) {
    ...
    localDW->UnitDelay2_DSTATE = localB->y_f;
   ...
   *  Sum: '<S23>/SumI2'
   */
  localDW->Integrator_DSTATE_g += ((localB->Saturate_o - localB->Sum_j) * 1.0 +
  ...
  localDW->Delay3_DSTATE = *rtu_attin1;
   ...
   *  Sum: '<S21>/SumI2'
   */
  localDW->Integrator_DSTATE_n += ((localB->Saturate_d - localB->Sum_m) * 1.0 +
   ...
   *  Sum: '<S20>/SumI2'
   */
  localDW->Integrator_DSTATE_k += ((localB->Saturate_h - localB->Sum_f) * 1.0 +
...
void px4demo_attitude_con_initialize(const char_T **rt_errorStatus, const
  ...
  px4demo_attitude_control2019_M, B_px4demo_attitude_control2_c_T *localB,
