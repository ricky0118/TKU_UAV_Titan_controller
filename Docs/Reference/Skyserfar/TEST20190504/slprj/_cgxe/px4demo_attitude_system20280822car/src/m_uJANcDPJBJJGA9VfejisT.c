...
static void cgxe_mdl_start(InstanceStruct_uJANcDPJBJJGA9VfejisT *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_uJANcDPJBJJGA9VfejisT
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_uJANcDPJBJJGA9VfejisT
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_uJANcDPJBJJGA9VfejisT *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_uJANcDPJBJJGA9VfejisT
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_uJANcDPJBJJGA9VfejisT *moduleInstance);
...
static void cgxe_mdl_set_sim_state(InstanceStruct_uJANcDPJBJJGA9VfejisT
...
static boolean_T g_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_uJANcDPJBJJGA9VfejisT
  *moduleInstance);
  ...
  *moduleInstance)
{
  ...
  moduleInstance->covInst = (covrtInstance *)cgxertGetCovrtInstance
    (moduleInstance->S);
  moduleInstance->u0 = (real32_T (*)[3])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_uJANcDPJBJJGA9VfejisT(SimStruct *S, int_T tid)
{
  InstanceStruct_uJANcDPJBJJGA9VfejisT *moduleInstance =
    (InstanceStruct_uJANcDPJBJJGA9VfejisT *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_uJANcDPJBJJGA9VfejisT(SimStruct *S)
{
  InstanceStruct_uJANcDPJBJJGA9VfejisT *moduleInstance =
    (InstanceStruct_uJANcDPJBJJGA9VfejisT *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_uJANcDPJBJJGA9VfejisT(SimStruct *S, int_T tid)
{
  InstanceStruct_uJANcDPJBJJGA9VfejisT *moduleInstance =
    (InstanceStruct_uJANcDPJBJJGA9VfejisT *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_uJANcDPJBJJGA9VfejisT(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_uJANcDPJBJJGA9VfejisT *moduleInstance =
    (InstanceStruct_uJANcDPJBJJGA9VfejisT *)cgxertGetRuntimeInstance(S);
...
static void setSimState_uJANcDPJBJJGA9VfejisT(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_uJANcDPJBJJGA9VfejisT *moduleInstance =
    (InstanceStruct_uJANcDPJBJJGA9VfejisT *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_uJANcDPJBJJGA9VfejisT(SimStruct *S)
{
  InstanceStruct_uJANcDPJBJJGA9VfejisT *moduleInstance =
    (InstanceStruct_uJANcDPJBJJGA9VfejisT *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_uJANcDPJBJJGA9VfejisT(SimStruct *S)
{
  InstanceStruct_uJANcDPJBJJGA9VfejisT *moduleInstance =
    (InstanceStruct_uJANcDPJBJJGA9VfejisT *)calloc(1, sizeof
    (InstanceStruct_uJANcDPJBJJGA9VfejisT));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_uJANcDPJBJJGA9VfejisT);
  ssSetmdlInitializeConditions(S, mdlInitialize_uJANcDPJBJJGA9VfejisT);
  ssSetmdlUpdate(S, mdlUpdate_uJANcDPJBJJGA9VfejisT);
  ssSetmdlTerminate(S, mdlTerminate_uJANcDPJBJJGA9VfejisT);
...
static void mdlProcessParameters_uJANcDPJBJJGA9VfejisT(SimStruct *S)
{
}

void method_dispatcher_uJANcDPJBJJGA9VfejisT(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_uJANcDPJBJJGA9VfejisT(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_uJANcDPJBJJGA9VfejisT(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_uJANcDPJBJJGA9VfejisT(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_uJANcDPJBJJGA9VfejisT(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: uJANcDPJBJJGA9VfejisT.\n"
...
mxArray *cgxe_uJANcDPJBJJGA9VfejisT_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_uJANcDPJBJJGA9VfejisT_fallback_info(void)
{
