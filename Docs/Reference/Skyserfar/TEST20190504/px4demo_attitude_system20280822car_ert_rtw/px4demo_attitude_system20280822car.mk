###########################################################################
## Makefile generated for Simulink model 'px4demo_attitude_system20280822car'. 
## 
## Makefile     : px4demo_attitude_system20280822car.mk
## Generated on : Tue Jul 30 11:29:16 2019
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/px4demo_attitude_system20280822car.pre.o
...
PRODUCT_NAME              = px4demo_attitude_system20280822car
MAKEFILE                  = px4demo_attitude_system20280822car.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = px4demo_attitude_system20280822car_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/px4demo_attitude_system20280822car.pre.o
...
DEFINES_STANDARD = -DMODEL=px4demo_attitude_system20280822car -DNUMST=5 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(MATLAB_ROOT)/toolbox/psp/pixhawk/src/PX4_sysobj_serial.c $(START_DIR)/px4demo_attitude_system20280822car_ert_rtw/px4demo_attitude_system20280822car.c $(START_DIR)/px4demo_attitude_system20280822car_ert_rtw/px4demo_attitude_system20280822car_data.c $(MATLAB_ROOT)/toolbox/psp/pixhawk/src/nuttxinitialize.c

MAIN_SRC = $(START_DIR)/px4demo_attitude_system20280822car_ert_rtw/ert_main.c
...
OBJS = PX4_sysobj_serial.o px4demo_attitude_system20280822car.o px4demo_attitude_system20280822car_data.o nuttxinitialize.o
...
MODELREF_LIBS = ./px4demo_attitude_control20180822car_rtwlib.lib
...
%.o : $(START_DIR)/px4demo_attitude_system20280822car_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"
