###########################################################################
## Makefile generated for Simulink model 'px4demo_attitude_control20180822car'. 
## 
## Makefile     : px4demo_attitude_control20180822car.mk
## Generated on : Tue Jul 30 10:34:58 2019
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: ./px4demo_attitude_control20180822car_rtwlib.lib
...
PRODUCT_NAME              = px4demo_attitude_control20180822car
MAKEFILE                  = px4demo_attitude_control20180822car.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = px4demo_attitude_control20180822car_ref.rsp
...
MODELLIB                  = px4demo_attitude_control20180822car_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
SHARED_OBJS               =  \
...
PRODUCT = ./px4demo_attitude_control20180822car_rtwlib.lib
...
DEFINES_ = -DSLMSG_ALLOW_SYSTEM_ALLOC -DMODEL=px4demo_attitude_control20180822car -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DUSE_STDPERIPH_DRIVER -DPX4 -DCONFIG_ARCH_BOARD_PX4FMU_V2 -DGIT_VERSION=d3398270e101359de9687c2d077d991c9892f573 -D__DF_NUTTX -D__PX4_NUTTX -DARM_MATH_CM4=1 -D__FPU_PRESENT=1 -D__FPU_USED=1 -DHSE_VALUE=8000000 -DNULL=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLEPRINTF -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=px4demo_attitude_control20180822car -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/ert/px4demo_attitude_control20180822car/px4demo_attitude_control20180822car.c
...
OBJS = px4demo_attitude_control20180822car.o
...
%.o : $(START_DIR)/slprj/ert/px4demo_attitude_control20180822car/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"
