...
static void cgxe_mdl_start(InstanceStruct_t1kSfRT32OS29myErLpFTF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_t1kSfRT32OS29myErLpFTF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_t1kSfRT32OS29myErLpFTF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_t1kSfRT32OS29myErLpFTF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_t1kSfRT32OS29myErLpFTF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_t1kSfRT32OS29myErLpFTF *moduleInstance);
...
static void cgxe_mdl_set_sim_state(InstanceStruct_t1kSfRT32OS29myErLpFTF
...
static boolean_T g_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_t1kSfRT32OS29myErLpFTF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_t1kSfRT32OS29myErLpFTF(SimStruct *S, int_T tid)
{
  InstanceStruct_t1kSfRT32OS29myErLpFTF *moduleInstance =
    (InstanceStruct_t1kSfRT32OS29myErLpFTF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_t1kSfRT32OS29myErLpFTF(SimStruct *S)
{
  InstanceStruct_t1kSfRT32OS29myErLpFTF *moduleInstance =
    (InstanceStruct_t1kSfRT32OS29myErLpFTF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_t1kSfRT32OS29myErLpFTF(SimStruct *S, int_T tid)
{
  InstanceStruct_t1kSfRT32OS29myErLpFTF *moduleInstance =
    (InstanceStruct_t1kSfRT32OS29myErLpFTF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_t1kSfRT32OS29myErLpFTF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_t1kSfRT32OS29myErLpFTF *moduleInstance =
    (InstanceStruct_t1kSfRT32OS29myErLpFTF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_t1kSfRT32OS29myErLpFTF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_t1kSfRT32OS29myErLpFTF *moduleInstance =
    (InstanceStruct_t1kSfRT32OS29myErLpFTF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_t1kSfRT32OS29myErLpFTF(SimStruct *S)
{
  InstanceStruct_t1kSfRT32OS29myErLpFTF *moduleInstance =
    (InstanceStruct_t1kSfRT32OS29myErLpFTF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_t1kSfRT32OS29myErLpFTF(SimStruct *S)
{
  InstanceStruct_t1kSfRT32OS29myErLpFTF *moduleInstance =
    (InstanceStruct_t1kSfRT32OS29myErLpFTF *)calloc(1, sizeof
    (InstanceStruct_t1kSfRT32OS29myErLpFTF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_t1kSfRT32OS29myErLpFTF);
  ssSetmdlInitializeConditions(S, mdlInitialize_t1kSfRT32OS29myErLpFTF);
  ssSetmdlUpdate(S, mdlUpdate_t1kSfRT32OS29myErLpFTF);
  ssSetmdlTerminate(S, mdlTerminate_t1kSfRT32OS29myErLpFTF);
...
static void mdlProcessParameters_t1kSfRT32OS29myErLpFTF(SimStruct *S)
{
}

void method_dispatcher_t1kSfRT32OS29myErLpFTF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_t1kSfRT32OS29myErLpFTF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_t1kSfRT32OS29myErLpFTF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_t1kSfRT32OS29myErLpFTF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_t1kSfRT32OS29myErLpFTF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: t1kSfRT32OS29myErLpFTF.\n"
...
mxArray *cgxe_t1kSfRT32OS29myErLpFTF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_t1kSfRT32OS29myErLpFTF_fallback_info(void)
{
