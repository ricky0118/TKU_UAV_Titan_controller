  ...
  *c3_inData)
{
  ...
  for (c3_i12 = 0; c3_i12 < 9; c3_i12++) {
    c3_u[c3_i12] = (*(real32_T (*)[9])c3_inData)[c3_i12];
  }

  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_create("y", c3_u, 1, 0U, 1U, 0U, 1, 9), false);
  sf_mex_assign(&c3_mxArrayOutData, c3_y, false);
  return c3_mxArrayOutData;
}
  ...
  chartInstance)
{
  chartInstance->c3_en = (boolean_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c3_data = (real32_T (*)[9])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3906866341U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(338526368U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3164704689U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2873835353U);
}
...
mxArray *sf_c3_pixhawk_slib_misc_utils_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("cmcdaVvAkVrpm0ML6b19E");
...
{
  return "s5I7oqGtyD9heRz2xiGNKpB";
}
...
static void mdlSetWorkWidths_c3_pixhawk_slib_misc_utils(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1898512539U));
  ssSetChecksum1(S,(3828071736U));
  ssSetChecksum2(S,(1875869265U));
  ssSetChecksum3(S,(2457061377U));
