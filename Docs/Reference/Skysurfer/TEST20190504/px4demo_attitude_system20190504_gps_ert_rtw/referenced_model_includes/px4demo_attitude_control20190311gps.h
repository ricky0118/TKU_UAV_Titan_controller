...
/* Block signals for model 'px4demo_attitude_control20190311gps' */
typedef struct {
  ...
  real32_T y_i;                        /* '<S3>/MATLAB Function9' */
  real32_T y_fv;                       /* '<S3>/MATLAB Function7' */
...
/* Block states (auto storage) for model 'px4demo_attitude_control20190311gps' */
typedef struct {
...
extern void px4demo_attitude_control2019031(const real32_T *rtu_roll, const
  ...
  uint16_T *rtu_ch6, const real32_T *rtu_P, const real32_T *rtu_Q, const
  real32_T *rtu_yaw, const int32_T *rtu_lat, const int32_T *rtu_long, const
  real32_T *rtu_attin1, uint16_T rty_PWM[4], boolean_T *rty_ARM_Control, real_T *
  rty_q1, real_T *rty_q, real32_T *rty_y_out, real32_T *rty_lat_out, real32_T
